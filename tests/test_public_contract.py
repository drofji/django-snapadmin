...
PUBLIC_IMPORTS = [
    ...
    # Encrypted field family (#CRYPT1c) — ciphertext at rest, natural Python
    # value in application code. Each is its plain counterpart plus encryption,
    # so the import path and kwargs of the plain one keep applying.
    "snapadmin.fields.SnapEncryptedField",
    "snapadmin.fields.SnapBlindIndexField",
    "snapadmin.fields.SnapEncryptedCharField",
    "snapadmin.fields.SnapEncryptedTextField",
    "snapadmin.fields.SnapEncryptedEmailField",
    "snapadmin.fields.SnapEncryptedJSONField",
    "snapadmin.fields.SnapEncryptedIntegerField",
    "snapadmin.fields.SnapEncryptedDecimalField",
    "snapadmin.fields.SnapEncryptedDateField",
    "snapadmin.fields.SnapEncryptedDateTimeField",
...
_BLESSED_REEXPORTS = {
    ...
    "snapadmin.fields": [
        ...
        "SnapEncryptedCharField", "SnapEncryptedTextField", "SnapEncryptedEmailField",
        "SnapEncryptedJSONField", "SnapEncryptedIntegerField", "SnapEncryptedDecimalField",
        "SnapEncryptedDateField", "SnapEncryptedDateTimeField", "SnapBlindIndexField",
    ],
