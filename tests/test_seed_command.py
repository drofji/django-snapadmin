...
def _seed_admin_password(monkeypatch):
    # Django forces DEBUG=False during tests, and seed_demo refuses the
    # insecure admin/admin default with DEBUG=False — supply a password.
    monkeypatch.setenv("SNAPADMIN_SEED_ADMIN_PASSWORD", "test-admin-pass")
